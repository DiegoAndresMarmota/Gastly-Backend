...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\Programador Full Stack\Test E-commerce Back-end\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\Programador Full Stack\Test E-commerce Back-end\venv\Scripts\deactivate.nu'
